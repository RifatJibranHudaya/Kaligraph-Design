          ...
          <tr>
            ...
            <td>
              <div style="display:flex; gap:6px; align-items:center; flex-wrap:wrap;">
                @if($pay->order)
                  <a href="{{ route('pembayaran.detail.order', $pay->order_id) }}" class="pembayaran-detail-link" title="Lihat Detail Order">
                    Detail
                  </a>
                @endif
