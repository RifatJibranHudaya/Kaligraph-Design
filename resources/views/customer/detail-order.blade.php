    ...
    <div class="card" style="position:sticky;top:90px;">
      ...
      <div style="padding:16px 0;">
        <div style="display:flex;justify-content:space-between;margin-bottom:12px;font-size:14px;">
          ...
          <span style="font-weight:700;color:var(--text-main);">Rp {{ number_format($orderTotal, 0, ',', '.') }}</span>
        </div>
        <div style="display:flex;justify-content:space-between;margin-bottom:12px;font-size:14px;">
          <span style="color:var(--text-muted);">Total Dibayar</span>
          <span style="font-weight:700;color:var(--success);">Rp {{ number_format($totalPaid, 0, ',', '.') }}</span>
        </div>
        <div style="display:flex;justify-content:space-between;margin-bottom:16px;font-size:14px;padding-top:12px;border-top:1px solid var(--border-color);">
          ...
          <span style="font-weight:800;color:var(--danger);">Rp {{ number_format($sisaTagihan, 0, ',', '.') }}</span>
        </div>
    ...
    <form method="POST" action="{{ route('customer.order.send.whatsapp', $order->id) }}">
      ...
      <div style="padding:0 24px 24px;">
        <div class="form-group">
          ...
          <small style="color:var(--text-muted);font-size:12px;display:block;margin-top:4px;">Nomor akan otomatis diformat ke standar WhatsApp.</small>
        </div>
